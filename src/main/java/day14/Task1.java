...
Fill it in manually with ten arbitrary numbers.txt. Implement a static method printSumDigits(File file) that calculates the
...
throw an exception and display the message “Incorrect input file” in the console.
*/
public class Task1 {
